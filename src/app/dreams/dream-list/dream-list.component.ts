...
export class DreamListComponent implements OnInit {
  ...
  constructor() {
    ...
    this.dreams.push(new Dream({name: 'Lakás kiadásra', description: 'Passziv jovedelemre fel!', price: 15000000, currentlyCovered: 1600000, imageUrl: "http://i.huffpost.com/gen/1478845/thumbs/o-136681404-900.jpg?1"}));
    this.dreams.push(new Dream({name: 'Lakás kiadásra', description: 'Passziv jovedelemre fel!', price: 15000000, currentlyCovered: 1600000, imageUrl: "http://i.huffpost.com/gen/1478845/thumbs/o-136681404-900.jpg?1"}));
    this.dreams.push(new Dream({name: 'Lakás kiadásra', description: 'Passziv jovedelemre fel!', price: 15000000, currentlyCovered: 1600000, imageUrl: "http://i.huffpost.com/gen/1478845/thumbs/o-136681404-900.jpg?1"}));
    this.dreams.push(new Dream({name: 'Lakás kiadásra', description: 'Passziv jovedelemre fel!', price: 15000000, currentlyCovered: 1600000, imageUrl: "http://i.huffpost.com/gen/1478845/thumbs/o-136681404-900.jpg?1"}));
    this.dreams.push(new Dream({name: 'Lakás kiadásra', description: 'Passziv jovedelemre fel!', price: 15000000, currentlyCovered: 1600000, imageUrl: "http://i.huffpost.com/gen/1478845/thumbs/o-136681404-900.jpg?1"}));
